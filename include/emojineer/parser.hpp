...
ast::StmtPtr statement();ast::StmtPtr module_declaration();ast::StmtPtr import_statement();ast::StmtPtr export_statement();ast::StmtPtr interop_import_declaration();ast::StmtPtr interop_export_declaration();ast::StmtPtr var_declaration();ast::StmtPtr assignment();ast::StmtPtr print_statement();ast::StmtPtr return_statement();ast::StmtPtr function_declaration();ast::StmtPtr if_statement();ast::StmtPtr while_statement();std::vector<ast::StmtPtr> block_until(TokenKind first,TokenKind second=TokenKind::Eof);
ast::DeclaredType required_declared_type(const std::string& message);
