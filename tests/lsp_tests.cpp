...
void test_e2e_real_supplementary_emoji_diagnostics() {
    ...
    // The invalid '@' follows four supplementary-plane emoji. In UTF-16 its exact
...
void test_e2e_real_diagnostics() {
    ...
    assert(diagResponse.find("file:") != std::string::npos &&
           diagResponse.find("test") != std::string::npos &&
           diagResponse.find("main.emoji") != std::string::npos &&
...
void test_e2e_real_hover() {
    ...
    // 📤 = Export (module), 📝 = Print/Output (ordinary runtime)
    // 🐍 🍎 🔢 🟰 42\n📝 🍎
    // UTF-16 positions line 0: 🐍(0), space(1), 🍎(3-4), space(4), 🔢(5-6), space(7), 🟰(8-9), space(10), 4(11), 2(12)
    // UTF-16 positions line 1: 📝(0-1), space(2), 🍎(3-4)
    // Request hover at position of 🍎 variable declaration (UTF-16 position 3-4)
    std::string didOpen = R"({"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///test/main.emoji","version":1,"languageId":"emojineer","text":"🐍 🍎 🔢 🟰 42\n📝 🍎"}}})";
    server.sendMessage(didOpen);
    server.readResponse(2000);

    // Request hover at position where 🍎 is defined (UTF-16 position 3-4)
    std::string hoverReq = R"({"jsonrpc":"2.0","id":3,"method":"textDocument/hover","params":{"textDocument":{"uri":"file:///test/main.emoji"},"position":{"line":0,"character":3}}})";
...
void test_e2e_real_definition() {
    ...
    assert(body.find("file:") != std::string::npos &&
           body.find("test") != std::string::npos &&
...
void test_e2e_real_references() {
    ...
    // UTF-16 positions line 0: 🐍(0), space(1), 🍎(3-4), space(4), 🔢(5-6), space(7), 🟰(8-9), space(10), 4(11), 2(12)
    // UTF-16 positions line 1: 📝(0-1), space(2), 🍎(3-4)
    // Request references at position of 🍎 definition (UTF-16 position 3)
    std::string didOpen = R"({"jsonrpc":"2.0","method":"textDocument/didOpen","params":{"textDocument":{"uri":"file:///test/main.emoji","version":1,"languageId":"emojineer","text":"🐍 🍎 🔢 🟰 42\n📝 🍎"}}})";
    server.sendMessage(didOpen);
    server.readResponse(2000);

    // Request references at position of 🍎 definition (UTF-16 position 3)
    std::string refsReq = R"({"jsonrpc":"2.0","id":3,"method":"textDocument/references","params":{"textDocument":{"uri":"file:///test/main.emoji"},"position":{"line":0,"character":3},"context":{"includeDeclaration":true}}})";
...
void test_e2e_real_mixed_workspace() {
    ...
    // Position after 🧩 and its following space (UTF-16 position 3)
    std::string compReq = R"({"jsonrpc":"2.0","id":3,"method":"textDocument/completion","params":{"textDocument":{"uri":")" + mainUri + R"("},"position":{"line":0,"character":3}}})";
    ...
    assert(body.find(".emojineer") != std::string::npos &&
    ...
    std::string compReq2 = R"({"jsonrpc":"2.0","id":11,"method":"textDocument/completion","params":{"textDocument":{"uri":")" + mainUri + R"("},"position":{"line":0,"character":3}}})";
